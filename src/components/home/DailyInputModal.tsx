...
export function DailyInputModal({ open, onClose }: Props) {
  ...
  const saveSleep = () => {
    const payload: Parameters<typeof upsertActivity.mutate>[0] = {
  ...
  const saveActivity = () => {
    const totalSecs =
      (parseInt(actHours) || 0) * 3600 + (parseInt(actMinutes) || 0) * 60
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                <Row label="Deep sleep">
                  <input type="number" placeholder="0" min={0}
                    value={deepMin} onChange={(e) => setDeepMin(e.target.value)}
                    style={inputSt} />
                </Row>
                <Row label="Light sleep">
                  <input type="number" placeholder="0" min={0}
                    value={lightMin} onChange={(e) => setLightMin(e.target.value)}
                    style={inputSt} />
                </Row>
                <Row label="REM sleep">
                  <input type="number" placeholder="0" min={0}
                    value={remMin} onChange={(e) => setRemMin(e.target.value)}
                    style={inputSt} />
                </Row>
                <Row label="Awake">
                  <input type="number" placeholder="0" min={0}
                    value={awakeMin} onChange={(e) => setAwakeMin(e.target.value)}
                    style={inputSt} />
                </Row>
            ...
            {tab === 'recovery' && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                <Row label="Resting heart rate (bpm)">
                  <input type="number" placeholder="e.g. 58" min={30} max={120}
                    value={rhr} onChange={(e) => setRhr(e.target.value)}
                    style={inputSt} />
                </Row>
                <Row label="Stress level (0–100)">
                  <input type="number" placeholder="e.g. 25" min={0} max={100}
                ...
                <Row label="Steps">
                  <input type="number" placeholder="e.g. 8000" min={0}
                    value={steps} onChange={(e) => setSteps(e.target.value)}
                    style={inputSt} />
                </Row>
                <Row label="Active minutes">
                  <input type="number" placeholder="e.g. 45" min={0}
                    value={activeMin} onChange={(e) => setActiveMin(e.target.value)}
                    style={inputSt} />
                </Row>
                ...
                <Row label="Distance (km)">
                  <input type="number" placeholder="e.g. 5.2" min={0} step={0.1}
            ...
            {tab === 'activity' && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                <Row label="Name (optional)">
                  <input type="text" placeholder="e.g. Morning run"
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', gap: 8 }}>
                    <div style={{ flex: 1 }}>
                      <input type="number" placeholder="0 h" min={0} max={23}
                        value={actHours} onChange={(e) => setActHours(e.target.value)}
                        style={{ ...inputSt, textAlign: 'center' }} />
                      <div style={{ fontSize: 10, color: 'var(--text3)', textAlign: 'center', marginTop: 3 }}>hours</div>
                    </div>
                    <div style={{ flex: 1 }}>
                      <input type="number" placeholder="0 min" min={0} max={59}
                        value={actMinutes} onChange={(e) => setActMinutes(e.target.value)}
                        style={{ ...inputSt, textAlign: 'center' }} />
                ...
                <Row label="Distance (km)">
                  <input type="number" placeholder="Optional" min={0} step={0.01}
                    value={actDistKm} onChange={(e) => setActDistKm(e.target.value)}
                    style={inputSt} />
                </Row>
                <Row label="Avg heart rate (bpm)">
                  <input type="number" placeholder="Optional" min={30} max={220}
                    value={actHR} onChange={(e) => setActHR(e.target.value)}
                    style={inputSt} />
                </Row>
                <Row label="Calories burned (kcal)">
                  <input type="number" placeholder="Optional" min={0}
                    value={actKcal} onChange={(e) => setActKcal(e.target.value)}
                    style={inputSt} />
                </Row>
  ...
  return (
    <button
      ...
      style={{
        ...
        padding: '11px 0', background: 'var(--accent)',
